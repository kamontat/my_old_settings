...
# _install_multiple_brew_application() {
#     loop_each_files "${RESOURCES_APPL}/choose-*.txt" _choose_to_install_brew_application

#     loop_each_files "${RESOURCES_APPL}/pack-*.txt" _install_brew_application_pack
# }

# _choose_to_install_brew_application() {
#     loop_each_libraries "$1" "brew_save_list" is_cask_installed true
#     choose_as_choice brew_cask_install ${SHOWED_LIBRARYS[@]}
# }

# _install_brew_application_pack() {
#     loop_each_libraries "$1" "brew_save_list" is_cask_installed
